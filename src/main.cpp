...
int main() {
  ...
  auto const reflective_sphere = rt::Material{.ambient = 0.0f,
                                              .diffuse = 0.05f,
                                              .shininess = 300.0f,
                                              .reflective = 0.9f};
  auto const refractive_sphere = rt::Material{.ambient = 0.0f,
                                              .diffuse = 0.05f,
                                              .shininess = 300.0f,
                                              .reflective = 0.9f,
                                              .transparency = 0.9f,
                                              .refractive_index = 1.5f};
  auto const checkered_floor = rt::Material{.pattern = checker_pattern};
  auto const world =
      builder.AddSphere(rt::Scaling(10.0f, 10.0f, 10.0f), {})
          .AddLight(rt::PointLight{rt::ColourRGB::Red(),
                                   rt::Point3(-4.0f, 3.0f, -4.0f)})
          .AddLight(rt::PointLight{rt::ColourRGB::Green(),
                                   rt::Point3(4.0f, 3.0f, -4.0f)})
          .AddLight(rt::PointLight{rt::ColourRGB::Blue(),
                                   rt::Point3(0.0f, 3.0f, -4.0f)})
          .AddSphere(
              rt::Scaling(0.2f, 0.2f, 0.2f) * rt::Translation(0.0f, 1.0, 0.0f),
              green_sphere)
          .AddSphere(
              rt::Scaling(0.2f, 0.2f, 0.2f) * rt::Translation(-4.0f, 1.0, 4.0f),
              red_sphere)
          .AddSphere(
              rt::Scaling(0.2f, 0.2f, 0.2f) * rt::Translation(-2.0f, 1.0, 5.5f),
              blue_sphere)
          .AddSphere(
              rt::Scaling(0.8f, 0.8f, 0.8f) * rt::Translation(2.0f, 1.0, 1.0f),
              purple_sphere)
          .AddSphere(rt::Scaling(0.4f, 0.4f, 0.4f) *
                         rt::Translation(-3.0f, 1.0, -0.5f),
                     reflective_sphere)
          .AddSphere(
              rt::Scaling(0.4f, 0.4f, 0.4f) * rt::Translation(1.0f, 1.0, -2.5f),
              refractive_sphere)
          .AddSphere(
              rt::Scaling(0.6f, 0.6f, 0.6f) * rt::Translation(0.0f, 1.0, -6.0f),
              purple_sphere)
          .AddSphere(rt::Scaling(0.2f, 0.2f, 0.2f) *
                         rt::Translation(-5.5f, 1.0, -7.0f),
                     cyan_sphere)
